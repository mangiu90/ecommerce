        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="flex">
                    ...
                    <p class="text-trueGray-700 mx-6">5 <i class="fas fa-star text-yellow-400"></i></p>
                ...
                <div class="bg-white rounded-lg shadow-lg mb-6">
                    <div class="p-4 flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-lg font-semibold text-greenLime-600">Se hace envíos a todo el pais</p>
